...
#                 self._f.close()
    ...
    def upload_to_gcp(self):
        ...
        blob = self.bucket.blob(f"big_index_anchor/{file_name}")
    ...
    def read(self, locs, n_bytes):
        ...
        for f_name, offset in locs:
            if f_name not in self._open_files:
                ...
                self._open_files[f_name] = open(f'big_index_anchor{os.sep}{f_name}', 'rb')
...
#                     posting_list.append((doc_id, tf))
                      posting_list.append(struct.unpack("I", b[i*TUPLE_SIZE:(i+1)*TUPLE_SIZE]))
...
#                               for doc_id, tf in pl])
    ...
    def _upload_posting_locs(bucket_id, posting_locs, bucket_name):
        ...
        blob_posting_locs = bucket.blob(f"big_index_anchor/{bucket_id}_posting_locs.pickle")
