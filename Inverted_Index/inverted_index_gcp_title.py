...
#                 self._f.close()
    ...
    def upload_to_gcp(self):
        ...
        blob = self.bucket.blob(f"big_index_title/{file_name}")
        ...
        for f_name, offset in locs:
            if f_name not in self._open_files:
              #  self._open_files[f_name] = open(f_name, 'rb')
                self._open_files[f_name] = open(f'big_index_title{os.sep}{f_name}', 'rb')
...
#                               for doc_id, tf in pl])
    ...
    def _upload_posting_locs(bucket_id, posting_locs, bucket_name):
        ...
        blob_posting_locs = bucket.blob(f"big_index_title/{bucket_id}_posting_locs.pickle")
